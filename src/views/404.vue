<template>
  <EmptyLayout>
    <div class="page">
      <div class="left">
        <p class="page_title">哎呀！</p>
        <p class="page_title title-one">页面找不到了！</p>
        <p class="page_content">可能的原因有：</p>
        <p class="page_content">网站可能在进行维护或出现了程序问题</p>
        <div class="d2-mt-return" @click="navigateHome">回到首页</div>
      </div>
      <div class="right">
